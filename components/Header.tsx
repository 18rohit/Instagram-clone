...
import {SearchIcon,PlusCircleIcon,UserGroupIcon,HomeIcon,PaperAirplaneIcon,MenuIcon, HeartIcon} from '@heroicons/react/outline'
      ...
      <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto">
        ...
        <div className='flex items-center justify-end space-x-4'>
          ...
          {session ? (
            ...
            <img onClick={signOut} src={session?.user?.image} alt="profile pic"  className='h-10 cursor-pointer rounded-full'/>
